...
class OrganigrammeController extends Controller
{
    ...
    {
          $organigramme1 = Organigramme::where('id','=',$id);
         $imageName = time().'.'.$request->image->getClientOriginalExtension();
            $request->image->move(public_path('/images/organigramme'), $imageName);

             $organigramme1->update(['image'=>$imageName, 'date'=>date('Y-m-d')]);
