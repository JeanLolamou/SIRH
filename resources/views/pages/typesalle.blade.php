@extends('templates/default')
  ...
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script> -->
          ...
          <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus"></i>Salle</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="{{route('home')}}">Accueil</a></li> 
             <li><i class="fa fa-plus"></i>Ajout salle</li>                
          </ol>
        </div>
      </div>
     <div class="row">
        ...
        <?php if (Auth::user()->id_role==3): ?>
          ...
          <div class="smallstat red-bg">
            ...
            <span class="title">Ajout salle</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->
        <?php endif ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Ajout salle</h4>
        </div>
        <div class="modal-body">
        <form method="POST" action="{{ route ('Typesalle.store')}}" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-folder-open red"></i><span class="break"></span><strong>Liste de salles</strong></h2>
 ...
 <input class = "form-control" id = "demo" type = "text" placeholder = "Seach here,..">
         ...
         <table class = "table table-bordered table-striped">
            ...
            <tbody id = "test">
              @foreach ($typesalle as $typesalle)
                  <tr>
                   <td>   
                     {{$typesalle->nom}}
                  </td>
                  <td>
                    ...
                    <?php if (Auth::user()->id_role==3): ?>
                         <a data-toggle="modal" data-target="#myModal{{$typesalle->id}}" type="button" class="btn btn-default" href="#" title="Suppression" data-rel="tooltip">
                 ...
                 <!-- Suppression -->
                    ...
                    <div class="modal fade" id="myModal{{$typesalle->id}}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-footer">
          <form action="{{ route ('Typesalle.update', $typesalle->id)}}" method="post" >
               {{ csrf_field() }}
              {{ method_field('PUT') }}
          <button type="button" class="btn btn-default" data-dismiss="modal">Annuler</button>
