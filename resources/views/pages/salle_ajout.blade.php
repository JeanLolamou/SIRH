     ...
     <!-- Css files -->
         ...
         <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus"></i> Nouvelle demande de salle</h3>
          <ol class="breadcrumb">
            ...
            <li><i class="fa fa-plus"></i>Nouvelle demande de salle</li>              
          </ol>
        </div>
      </div>
        ...
        <div class="col-lg-12">
           <div class="panel panel-default">
                  <div class="panel-heading">
                      <h2><i class="fa fa-indent red"></i><strong>Nouvelle demande de salle</strong></h2>
                  </div>
             ...
             <form method="POST" action="{{ route ('Reunion.store')}}" enctype="multipart/form-data">
                        ...
                        <input type="text" id="nf-password" name="libelle" class="form-control" placeholder="Sujet">
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                             <label for="direction-w1">Salle</label>
