@extends('templates/default')
  ...
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script> -->
          ...
          <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-plus"></i> Direction</h3>
          <ol class="breadcrumb">
     ...
     <div class="row">
        ...
        <?php if (Auth::user()->id_role==3): ?>
          ...
          <div class="smallstat red-bg">
            ...
            <span class="title">Ajout direction</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->
        <?php endif ?>
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-folder-open red"></i><span class="break"></span><strong>Directions</strong></h2>
              ...
              @foreach ($direction as $direction)
                  ...
                  <td>
                    ...
                    <?php if (Auth::user()->id_role==3): ?>
                     ...
                     <a class="btn btn-info" href="{{ route ('Direction.edit', $direction->id)}}" title="Modifier" data-rel="tooltip">
