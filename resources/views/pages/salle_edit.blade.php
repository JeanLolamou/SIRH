      ...
      <div class="row profile">
        ...
        <div class="col-md-8">
                    ...
                    <div class="panel panel-default">                               
                        ...
                        <div class="panel-body">
                           <form action="{{ route ('Reunion.update', $reunion->id)}}" method="post" enctype="multipart/form-data" class="form-vertical hover-stripped" role="form">
                       {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <input type="hidden" name="modif" value="1">
                          ...
                          <input name="libelle" type="text" class="form-control" id="daterange" value="{{$reunion->libelle}}">
                        </div>
                  ...
                  <div class="input-group col-sm-4">
                    ...
                    <input name="date" type="date" class="form-control" id="daterange" value="{{$reunion->date}}">
                  </div>
                  </div>
                </div>
                        </div>
                  ...
                  <div class="input-group col-sm-4">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    <input name="heur_debut" type="time" class="form-control" id="daterange" value="{{$reunion->heur_debut}}">
                  </div>
                  </div>
                </div>
                        </div>
                  ...
                  <div class="input-group col-sm-4">
                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    <input name="heur_fin" type="time" class="form-control" id="daterange" value="{{$reunion->heur_fin}}">
                  </div>
                  </div>
                </div>
                        </div>
