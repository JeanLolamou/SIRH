        ...
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="{{route('home')}}">Accueil</a></li>
             <li><i class="fa fa-exchange"></i>Délégation</li>            
          </ol>
        </div>
      </div>
     ...
     <div class="row">
        ...
        <div class="col-md-4 col-sm-5 col-xs-6 col-xxs-12">
          <div class="smallstat red-bg">
            <a href="#" data-toggle="modal" data-target="#delegation"><i class="fa fa-plus white-bg"></i>

            <span class="title">Faire une delegation</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->

         <!-- Delegation -->

                    <div class="modal fade" id="delegation">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Délégation</h4>
        </div>
        <div class="modal-body">
          <p>  <form method="POST" action="{{ route ('Delegation.store')}}" enctype="multipart/form-data">
                        @csrf
             
                       <div class="form-group">
                             <label for="direction-w1">Collaborateur</label>
                          <select class="form-control" name="delegue">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type=" button submit"><i class="fa fa-trash"></i> DELEGUER</button>
         ...
         <div class="col-md-4 col-sm-5 col-xs-6 col-xxs-12">
          <div class="smallstat blue-bg">
            <a href="{{route('all_delegation')}}"><i class="fa fa-exchange white-bg"></i>

            <span class="title">Toutes les délégation</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h2><i class="fa fa-table red"></i><span class="break"></span><strong>Mes délégations</strong></h2>
