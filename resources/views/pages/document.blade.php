@extends('templates/default')
  ...
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script> -->
          ...
          <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-folder-open"></i> MES DOCUMENTS</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="{{route('home')}}">Accueil</a></li>
            <li><i class="fa fa-folder-open"></i>Mes documents</li>                
          </ol>
        </div>
      </div>
     <div class="row">
        ...
        <?php endif ?>
         ...
         <div class="col-md-4 col-sm-5 col-xs-6 col-xxs-12">
          <div class="smallstat red-bg">
            <a href="{{ route ('documentpartage')}}"><i class="fa fa-file white-bg"></i>

            <span class="title">Documents utiles</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->
            ...
            <tbody id = "test">
              @foreach ($document as $documents)
                  ...
                  <td>
                   ...
                   <?php endif ?>
                   <?php if ($documents->type=="demande_document"): ?>
                      <td>
                       <a class="btn" target="_blank" href="{{ asset('document/demande_document/'.$documents->libelle.'')}}" download title="Voir le document" data-rel="tooltip">
                      <img class="img-profile" src="{{ asset('img/fichier2.png')}}" style="max-height: 50px;max-width: 50px;">                                
                    </a>
                  </td>
                    <td>
                      Document Demandé
                  ...
                  <td>
                   ...
                   <?php endif ?>
                    <?php if ($documents->type=="conge"): ?>
                      <td>  <a class="btn" target="_blank" href="{{ asset('document/conge/'.$documents->libelle.'')}}" download title="Voir le document" data-rel="tooltip">
                  ...
                  <td>
                   ...
                   <?php endif ?>
                     ...
                     <?php if ($documents->type=="document_profession"): ?>
                      <td>  <a class="btn" target="_blank" href="{{ asset('document/document_profession/'.$documents->libelle.'')}}" download title="Voir le document" data-rel="tooltip">
                      <img class="img-profile" src="{{ asset('img/fichier3.jpg')}}" style="max-height: 50px;max-width: 50px;">                                
                    </a>
                  </td>
                    <td>
