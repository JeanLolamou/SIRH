...
<head>
        ...
        <!--[if lt IE 9]>
<link href="{{ asset('http://fonts.googleapis.com/css?family=Open+Sans:400') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('http://fonts.googleapis.com/css?family=Open+Sans:700') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('http://fonts.googleapis.com/css?family=Droid+Sans:400') }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('http://fonts.googleapis.com/css?family=Droid+Sans:700') }}" rel="stylesheet" type="text/css" />
<![endif]-->
...
<body>
	        ...
	        <ul class="nav navbar-nav navbar-right">
				<li class="dropdown visible-md visible-lg">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="img/avatar3.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="img/avatar4.jpg">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="img/avatar5.jpg">
								<div>New message</div>
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="img/avatar.jpg" alt="user-mail">raphael@mail.com</a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header">
			...
			<div class="sidebar ">
				...
				<div class="sidebar-collapse">
					<div class="sidebar-header t-center">
                        <span><img class="text-logo" src="img/logo1.png"><i class="fa fa-space-shuttle fa-3x blue"></i></span>
                    </div>										
				...
				<div class="sidebar-footer">					
					...
					<div class="copyright text-center">
						<small>&copy; 2014 All Right Reserved.</small>
					</div>					
				</div>	
	...
	<script src="{{ asset('js/query.ui.touch-punch.min.js') }}"></script>
