@extends('templates/default')
  ...
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script> -->
          ...
          <div class="row">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-sun-o"></i> DEMANDES DE CONGES</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="{{route('home')}}">Accueil</a></li>
            <li><i class="fa fa-sun-o"></i>Demande de congés</li>                
          </ol>
        </div>
      </div>
     <div class="row">
        ...
        <div class="col-md-5 col-sm-5 col-xs-6 col-xxs-12">
         ...
         <div class="col-md-4 col-sm-4 col-xs-6 col-xxs-12">
          <div class="smallstat blue-bg">
            <a href="{{route('liste_all_conge')}}"><i class="fa fa-folder-open white-bg"></i>

            <span class="title">Tous les congés</span></a>
          </div><!--/.smallstat-->
        </div><!--/.col-->
