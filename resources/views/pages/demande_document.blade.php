@extends('templates/default')
 ...
 <input class = "form-control" id = "demo" type = "text" placeholder = "Seach here,..">
         ...
         <table class = "table table-bordered table-striped">
            ...
            <?php endif ?>
                     <?php if ($document->statut==0): ?>
               <a data-toggle="modal" data-target="#valide{{$document->id}}" class="btn btn-primary"  href="#" title="Repondre à la demande" data-rel="tooltip">
                      <i class="fa fa-check"></i>                                            
                    </a>
                     <a data-toggle="modal" data-target="#annule{{$document->id}}" class="btn btn-danger"  href="#" title="Annuler la demande." data-rel="tooltip">
            ...
            <?php endif ?>
                    ...
                    <div class="modal fade" id="valide{{$document->id}}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Repondre à la demande</h4>
        </div>
        <div class="modal-body">
          <form action="{{ route ('DemandeDocument.update', $document->id)}}" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
              {{ method_field('PUT') }}
          <p>   <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input type="file" name="file[]" multiple class="form-control" placeholder="" required>

                            <span class="help-block">Vous pouvez choisir plusieurs fichiers</span>
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type=" button submit"><i class="fa fa-trash"></i> Envoyer</button>
  ...
  <!-- Annulation -->
                    ...
                    <div class="modal fade" id="annule{{$document->id}}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
